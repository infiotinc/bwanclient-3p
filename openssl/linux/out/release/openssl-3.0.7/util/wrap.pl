...
BEGIN {
    ...
    require '/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/openssl-3.0.7/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/openssl-3.0.7/test/fips-and-base.cnf';
    shift;
