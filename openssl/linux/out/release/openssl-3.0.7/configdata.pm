...
our %config = (
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/ssl",
    "options" => "--prefix=/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release --openssldir=/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/ssl no-acvp-tests no-asan no-autoload-config no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "7",
    ...
    "perlargv" => [
        "disable-shared",
        "no-autoload-config",
        "--prefix=/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release",
        "--openssldir=/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/ssl"
    ],
    "perlenv" => {
        "AR" => undef,
...
unless (caller) {
    ...
    use lib '/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/openssl-3.0.7/util/perl';
    use OpenSSL::fallback '/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/openssl-3.0.7/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/anand/src/ns/bwanclient-3p/openssl/linux/out/release/openssl-3.0.7/Configurations';
        use gentemplate;
