...
extern "C" {
  ...
  NDPI_WIN_EXPORT void *ndpi_tdelete(const void * __restrict, void ** __restrict,
		     int (*)(const void *, const void *));
  NDPI_WIN_EXPORT void *ndpi_tfind(const void *, void *, int (*)(const void *, const void *));
  NDPI_WIN_EXPORT void *ndpi_tsearch(const void *, void**, int (*)(const void *, const void *));
  NDPI_WIN_EXPORT void ndpi_twalk(const void *, void (*)(const void *, ndpi_VISIT, int, void*), void *user_data);
  NDPI_WIN_EXPORT void ndpi_tdestroy(void *vrootp, void (*freefct)(void *));
  ...
  NDPI_WIN_EXPORT char* ndpi_get_proto_by_id(struct ndpi_detection_module_struct *ndpi_mod, u_int id);
  NDPI_WIN_EXPORT u_int16_t ndpi_get_proto_by_name(struct ndpi_detection_module_struct *ndpi_mod, const char *name);
